...
CHEM = '("химическ* состав" OR минерализац* OR "ионный состав" OR pH OR дебит OR температура OR радон OR "сероводород" OR CO2 OR углекисл*)'
CLIN = '("питьевое лечение" OR "внутреннее применение" OR бальнеотерап* OR курортолог* OR "санаторно-курортн*" OR показани* OR противопоказани*)'
SOURCEOBJ = '(источник* OR скважин* OR каптаж OR галерея OR "паспорт источника" OR "режим эксплуатации" OR "санитарная охрана")'
DOC = '("методические указания" OR "клинические наблюдения" OR диссертац* OR автореферат OR "гидрогеологическ* отчет" OR "паспорт скважины")'
