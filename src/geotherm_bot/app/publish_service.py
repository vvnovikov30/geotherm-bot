...
class PublishService:
    ...
    def publish_next_for_chat(self, chat_id: int, now: datetime) -> Dict[str, any]:
        ...
        Алгоритм:
        1. Выбирает топик по fairness: NULL last_post_at первыми, затем по last_post_at ASC, затем по created_at ASC
        ...
        # Сортируем по fairness: NULL last_post_at первыми, затем по last_post_at ASC, затем по created_at ASC
