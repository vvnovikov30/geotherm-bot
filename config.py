...
INCLUDE_TERMS = [
    "mineral water", "thermal mineral water", "balneotherapy", "spa therapy",
    "hot spring", "onsen", "bicarbonate", "sulfate"
]

# Термины для исключения (не должны быть в title или summary)
EXCLUDE_TERMS = [
    "wastewater", "water pollution", "water treatment", "sewage", "microplastics", "chlorination",
    "aquatic", "fish", "river", "desalination",
    "yoga", "naturopathy", "acupuncture",
    "murine", "mice", "rat", "piglet", "in vitro", "tensile", "fiber", "luffa",
    "protocol", "study protocol", "corrigendum", "comment"
]
